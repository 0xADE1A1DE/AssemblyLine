...
const static struct instr_table INSTR_TABLE[] = {
    ...
    {"prefetcht0",  prefetcht0,  {r, m},     M,   OTHER,          NA,  NA,  1,   3,  0, {0x0f, 0x18, REG}},
    {"prefetcht1",  prefetcht1,  {r, m},     M,   OTHER,          NA,  NA,  2,   3,  0, {0x0f, 0x18, REG}},
    {"prefetcht2",  prefetcht2,  {r, m},     M,   OTHER,          NA,  NA,  3,   3,  0, {0x0f, 0x18, REG}},
    {"prefetchnta", prefetchnta, {r, m},     M,   OTHER,          NA,  NA,  0,   3,  0, {0x0f, 0x18, REG}},
