...
const struct instr_table INSTR_TABLE[] = {
    ...
    {"bzhi",        bzhi,        {rrr, rmr}, RMV, VECTOR,         NA,  NA,  NA,  5,  3, {0xc4, VEX, W0, 0xf5, REG}},
    ...
    {"sarx",        sarx,        {rrr, rmr}, RMV, VECTOR,         NA,  NA,  NA,  5,  1, {0xc4, VEX, W0, 0xf7, REG}},
    ...
    {"shlx",        shlx,        {rrr, rmr}, RMV, VECTOR,         NA,  NA,  NA,  5,  2, {0xc4, VEX, W0, 0xf7, REG}},
    ...
    {"shrx",        shrx,        {rrr, rmr}, RMV, VECTOR,         NA,  NA,  NA,  5,  0, {0xc4, VEX, W0, 0xf7, REG}},
