...
***note: refer to [/src/instructions.h](https://github.com/0xADE1A1DE/AssemblyLine/tree/main/src/supported_instructions.h) for a complete list of supported instructions***
