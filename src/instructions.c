...
const struct instr_table INSTR_TABLE[] = {
    ...
    {"movd",        movd,        {NA, vr},   RM,  DATA_TRANSFER,  NA,  NA,  NA,  5,  0, {0x66, REX, 0x0f, 0x6e, REG}},
    {{'\0'},        movd,        {NA, rv},   MR,  DATA_TRANSFER,  NA,  NA,  NA,  5,  0, {0x66, REX, 0x0f, 0x7e, REG}},
    {"movntdqa",    movntdqa,    {NA, vm},   RM,  DATA_TRANSFER,  NA,  NA,  NA,  7,  0, {EVEX, 0x66, REX, 0x0f, 0x38, 0x2a, REG}},
    {"movntq",      movntq,      {NA, mr},   MR,  DATA_TRANSFER,  NA,  NA,  NA,  5,  0, {NP, REX, 0x0f, 0xe7, REG}},
    {"movq",        movq,        {NA, vr},   RM,  DATA_TRANSFER,  NA,  NA,  NA,  5,  0, {0x66, REX, 0x0f, 0x6e, REG}},
    {{'\0'},        movq,        {vm, vv},   RM,  DATA_TRANSFER,  NA,  NA,  NA,  4,  0, {0xf3, 0x0f, 0x7e, REG}},
    {{'\0'},        movq,        {NA, rv},   MR,  DATA_TRANSFER,  NA,  NA,  NA,  5,  0, {0x66, REX, 0x0f, 0x7e, REG}},
    {"movzx",       movzx,       {rr, rm},   RM,  DATA_TRANSFER,  NA,  NA,  NA,  4,  0, {REX, 0x0f, 0xb6, REG}},
    {"mulpd",       mulpd,       {NA, vv},   RM,  OTHER,          NA,  NA,  NA,  5,  0, {0x66, REX, 0x0f, 0x59, REG}},
    ...
    {"paddb",       paddb,       {NA, vv},   RM,  OTHER,          NA,  NA,  NA,  5,  0, {0x66, REX, 0x0f, 0xfc, REG}},
    {"paddd",       paddd,       {NA, vv},   RM,  OTHER,          NA,  NA,  NA,  5,  0, {0x66, REX, 0x0f, 0xfe, REG}},
    ...
    {"pmulhuw",     pmulhuw,     {NA, vv},   RM,  OTHER,          NA,  NA,  NA,  5,  0, {0x66, REX, 0x0f, 0xe4, REG}},
    ...
    {"psubb",       psubb,       {NA, vv},   RM,  OTHER,          NA,  NA,  NA,  5,  0, {0x66, REX, 0x0f, 0xf8, REG}},
    {"psubd",       psubq,       {NA, vv},   RM,  OTHER,          NA,  NA,  NA,  5,  0, {0x66, REX, 0x0f, 0xfa, REG}},
    {"psubq",       psubq,       {NA, vv},   RM,  OTHER,          NA,  NA,  NA,  5,  0, {0x66, REX, 0x0f, 0xfb, REG}},
    {"psubw",       psubw,       {NA, vv},   RM,  OTHER,          NA,  NA,  NA,  5,  0, {0x66, REX, 0x0f, 0xf9, REG}},
