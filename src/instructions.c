...
const struct instr_table INSTR_TABLE[] = {
    ...
    {"bzhi",        bzhi,        {rrr, rmr}, RMV, OTHER,          NA,  NA,  NA,  5,  3, {0xc4, VEX, W0, 0xf5, REG}},
    ...
    {{'\0'},        ja,          {NA, NA},   S,   CONTROL_FLOW,   NA,  NA,  NA,  2,  0, {0x77, ib}},
    {"jae",         jae,         {n,  n},    D,   CONTROL_FLOW,   NA,  NA,  NA,  2,  0, {0x0f, 0x83}},
    {{'\0'},        jae,         {NA, NA},   S,   CONTROL_FLOW,   NA,  NA,  NA,  2,  0, {0x73, ib}},
    {"jb",          jb,          {n,  n},    D,   CONTROL_FLOW,   NA,  NA,  NA,  2,  0, {0x0f, 0x82}},
    {{'\0'},        jb,          {NA, NA},   S,   CONTROL_FLOW,   NA,  NA,  NA,  2,  0, {0x72, ib}},
    {"je",          je,          {n,  n},    D,   CONTROL_FLOW,   NA,  NA,  NA,  2,  0, {0x0f, 0x84}},
    {{'\0'},        je,          {NA, NA},   S,   CONTROL_FLOW,   NA,  NA,  NA,  2,  0, {0x74, ib}},
    {"jg",          jg,          {n,  n},    D,   CONTROL_FLOW,   NA,  NA,  NA,  2,  0, {0x0f, 0x8f}},
    {{'\0'},        jg,          {NA, NA},   S,   CONTROL_FLOW,   NA,  NA,  NA,  2,  0, {0x7f, ib}},
    {"jge",         jge,         {n,  n},    D,   CONTROL_FLOW,   NA,  NA,  NA,  2,  0, {0x0f, 0x8d}},
    {{'\0'},        jge,         {NA, NA},   S,   CONTROL_FLOW,   NA,  NA,  NA,  2,  0, {0x7d, ib}},
    {{'\0'},        jbe,         {n,  n},    D,   CONTROL_FLOW,   NA,  NA,  NA,  2,  0, {0x0f, 0x86}},
    {{'\0'},        jbe,         {NA, NA},   S,   CONTROL_FLOW,   NA,  NA,  NA,  2,  0, {0x76, ib}},
    {"jl",          jl,          {n,  n},    D,   CONTROL_FLOW,   NA,  NA,  NA,  2,  0, {0x0f, 0x8c}},
    {{'\0'},        jl,          {NA, NA},   S,   CONTROL_FLOW,   NA,  NA,  NA,  2,  0, {0x7c, ib}},
    {"jle",         jle,         {n,  n},    D,   CONTROL_FLOW,   NA,  NA,  NA,  2,  0, {0x0f, 0x8e}},
    {{'\0'},        jle,         {NA, NA},   S,   CONTROL_FLOW,   NA,  NA,  NA,  2,  0, {0x7e, ib}},
    {"jmp",         jmp,         {n,  n},    D,   CONTROL_FLOW,   NA,  NA,  NA,  1,  0, {0xe9}},    
    {{'\0'},        jmp,         {NA, NA},   S,   CONTROL_FLOW,   NA,  NA,  NA,  2,  0, {0xeb, ib}},
    ...
    {{'\0'},        jne,         {NA, NA},   S,   CONTROL_FLOW,   NA,  NA,  NA,  2,  0, {0x75, ib}},
    {"jno",         jno,         {n,  n},    D,   CONTROL_FLOW,   NA,  NA,  NA,  2,  0, {0x0f, 0x81}},
    {{'\0'},        jno,         {NA, NA},   S,   CONTROL_FLOW,   NA,  NA,  NA,  2,  0, {0x71, ib}},
    {"jnp",         jnp,         {n,  n},    D,   CONTROL_FLOW,   NA,  NA,  NA,  2,  0, {0x0f, 0x8b}},
    {{'\0'},        jnp,         {NA, NA},   S,   CONTROL_FLOW,   NA,  NA,  NA,  2,  0, {0x7b, ib}},
    {"jns",         jns,         {n,  n},    D,   CONTROL_FLOW,   NA,  NA,  NA,  2,  0, {0x0f, 0x89}},
    {{'\0'},        jns,         {NA, NA},   S,   CONTROL_FLOW,   NA,  NA,  NA,  2,  0, {0x79, ib}},
    {"jo",          jo,          {n,  n},    D,   CONTROL_FLOW,   NA,  NA,  NA,  2,  0, {0x0f, 0x80}},
    {{'\0'},        jo,          {NA, NA},   S,   CONTROL_FLOW,   NA,  NA,  NA,  2,  0, {0x70, ib}},
    {"jp",          jp,          {n,  n},    D,   CONTROL_FLOW,   NA,  NA,  NA,  2,  0, {0x0f, 0x8a}},
    {{'\0'},        jp,          {n,  n},    S,   CONTROL_FLOW,   NA,  NA,  NA,  2,  0, {0x7a, ib}},
    {"jrcxz",       jrcxz,       {n,  n},    S,   CONTROL_FLOW,   NA,  NA,  NA,  2,  0, {0xe3, ib}},
    {{'\0'},        jrcxz,       {NA, NA},   S,   CONTROL_FLOW,   NA,  NA,  NA,  2,  0, {0xe3, ib}},
    {"js",          js,          {n,  n},    D,   CONTROL_FLOW,   NA,  NA,  NA,  2,  0, {0x0f, 0x88}},
    {{'\0'},        js,          {NA,  NA},  S,   CONTROL_FLOW,   NA,  NA,  NA,  2,  0, {0x78, ib}},
    ...
    {"rcr",         rcr,         {mi, ri},   M,   SHIFT,          1,   NA,  3,   4,  0, {REX, 0xd0, REG, ib}},
    {{'\0'},        rcr,         {NA, NA},   M,   SHIFT,          1,   NA,  2,   4,  0, {REX, 0xc1, REG, ib}},
    ...
    {"ror",         ror,         {NA, ri},   M,   SHIFT,          NA,  NA,  1,   4,  0, {REX, 0xd1, REG, ib}},
    {{'\0'},        ror,         {NA, NA},   M,   SHIFT,          NA,  NA,  1,   4,  0, {REX, 0xc1, REG, ib}},
    {"rorx",        rorx,        {rri, rmi}, RM,  OTHER,          NA,  NA,  NA,  6,  0, {0xc4, VEX, 0xfb, 0xf0, REG, ib}},
    {"sar",         sar,         {mi, ri},   M,   SHIFT,          1,   NA,  7,   4,  0, {REX, 0xd0, REG, ib}},
    {{'\0'},        sar,         {NA, NA},   M,   SHIFT,          1,   NA,  7,   4,  0, {REX, 0xc0, REG, ib}},
    {"sarx",        sarx,        {rrr, rmr}, RMV, OTHER,          NA,  NA,  NA,  5,  1, {0xc4, VEX, W0, 0xf7, REG}},
    ...
    {"shl",         shl,         {NA, ri},   M,   SHIFT,          NA,  NA,  4,   4,  0, {REX, 0xd1, REG, ib}},
    {{'\0'},        shl,         {NA, NA},   M,   SHIFT,          NA,  NA,  4,   4,  0, {REX, 0xc1, REG, ib}},
    {"shld",        shld,        {rri, mri}, MR,  OTHER,          NA,  NA,  NA,  5,  0, {REX, 0x0f, 0xa4, REG, ib}},
    {"shld",        shld,        {rrr, mrr}, MR,  OTHER,          NA,  NA,  NA,  4,  0, {REX, 0x0f, 0xa5, REG}},
    {"shlx",        shlx,        {rrr, rmr}, RMV, OTHER,          NA,  NA,  NA,  5,  2, {0xc4, VEX, W0, 0xf7, REG}},
    {"shr",         shr,         {NA, ri},   M,   SHIFT,          1,   NA,  5,   4,  0, {REX, 0xbe, REG, ib}},
    {{'\0'},        shr,         {NA, NA},   M,   SHIFT,          NA,  NA,  5,   4,  0, {REX, 0xc1, REG, ib}},
    {{'\0'},        shr,         {NA, rr},   M,   SHIFT,          NA,  NA,  5,   3,  0, {REX, 0xd3, REG}},
    {"shrd",        shrd,        {NA, rri},  MR,  OTHER,          2,   NA,  NA,  4,  0, {REX, 0x0f, 0xa9, REG}},
    {"shrx",        shrx,        {rrr, rmr}, RMV, OTHER,          NA,  NA,  NA,  5,  0, {0xc4, VEX, W0, 0xf7, REG}},
